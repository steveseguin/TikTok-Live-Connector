...
class WebcastPushConnection extends EventEmitter {
  ...
  async sendMessage(text, sessionId) {
    ...
    try {
      ...
      _classPrivateFieldGet(this, _httpClient).setSessionId(_classPrivateFieldGet(this, _options).sessionId);
      ...
      let response = await _classPrivateFieldGet(this, _httpClient).postFormDataToWebcastApi('room/chat/', requestParams, null);
